...
enum CONNECTIONINFO_ACCESS { ANY, PROTECTED, SUPER }
...
enum GROUPINFO_ACCESS { ANY, PROTECTED, SUPER }
...
class GroupInfo extends CommonInfoBase {
  ...
  Map<String, dynamic> toJson() {
    return {"groupName": groupName, "creator": creatorConnectionInfo.toJson()};
  }
...
class PublishInfo extends CommonInfoBase {
  ...
  Map<String, dynamic> toJson() {
    return {"groupName": groupName, "publishData": publishData};
  }
...
class HyperCubeCommand {
  ...
  bool ack = false;
  HyperCubeCommand(
      HYPERCUBECOMMANDS _command, dynamic _jsonData, bool _status) {
    command = _command;
    jsonData = _jsonData;
    status = _status;
    ack = false;
  ...
  init(
      HYPERCUBECOMMANDS _command, CommonInfoBase commonInfoBase, bool _status) {
    command = _command;
